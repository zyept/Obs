--------------------------------------------------------
--  File created - Perþembe-Aralýk-28-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."TEACHER_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 6 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table A_CLASSROOM
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_CLASSROOM" 
   (	"CLASSROOM_ID" NUMBER, 
	"TEACHER_ID" NUMBER, 
	"STUDENT_ID" NUMBER, 
	"COURSE_ID" NUMBER, 
	"ATTANDANCE" NUMBER(1,0) DEFAULT 0, 
	"SECTION_NUM" NUMBER, 
	"HOUR" VARCHAR2(20 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table A_CLASSROOM_STUDENT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_CLASSROOM_STUDENT" 
   (	"CLASSROOM_ID" NUMBER, 
	"STUDENT_ID" NUMBER, 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table A_DEPARTMENT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_DEPARTMENT" 
   (	"DEP_ID" NUMBER(38,0), 
	"DEP_NAME" VARCHAR2(60 BYTE), 
	"FACULTY_ID" NUMBER(38,0), 
	"DEP_YEAR" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table A_FACULTY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_FACULTY" 
   (	"FACULTY_ID" NUMBER(38,0), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table A_GRADE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_GRADE" 
   (	"GRADE_ID" NUMBER(*,0), 
	"CLASSROOM_ID" NUMBER(*,0), 
	"STUDENT_ID" NUMBER(*,0), 
	"EXAM_TYPE" VARCHAR2(10 BYTE), 
	"NUMERIC_GRADE" FLOAT(126), 
	"LETTER_GRADE" VARCHAR2(2 BYTE), 
	"PASS_FAIL" NUMBER(1,0) DEFAULT 0
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table A_STUDENT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_STUDENT" 
   (	"STUDENT_ID" NUMBER(38,0), 
	"FNAME" VARCHAR2(80 BYTE), 
	"LNAME" VARCHAR2(80 BYTE), 
	"MAIL" VARCHAR2(80 BYTE), 
	"PHONE_NUMBER" VARCHAR2(80 BYTE), 
	"GPA" VARCHAR2(80 BYTE), 
	"CLASS_NUM" VARCHAR2(80 BYTE), 
	"PASSWORD" VARCHAR2(80 BYTE), 
	"IDENTITY_NUM" VARCHAR2(80 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table A_TEACHER
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."A_TEACHER" 
   (	"TEACHER_ID" NUMBER(38,0), 
	"FNAME" VARCHAR2(40 BYTE), 
	"LNAME" VARCHAR2(40 BYTE), 
	"IDENTITY_NUMBER" VARCHAR2(40 BYTE), 
	"MAIL" VARCHAR2(40 BYTE), 
	"ROOM_NUMBER" VARCHAR2(40 BYTE), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CLASSROOM_STUDENT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CLASSROOM_STUDENT" 
   (	"CLASSROOM_ID" NUMBER, 
	"STUDENT_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table DEPARTMENT_STUDENT
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."DEPARTMENT_STUDENT" 
   (	"STUDENT_ID" NUMBER, 
	"DEPARTMENT_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."EXAM_RESULT" 
   (	"EXAM_ID" NUMBER, 
	"STUDENT_ID" NUMBER, 
	"COURSE_ID" NUMBER, 
	"MARKS" NUMBER
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."STUDENT" 
   (	"STUDENT_ID" NUMBER(*,0), 
	...
	"MAIL" VARCHAR2(40 BYTE), 
	"PHONE_NUMBER" VARCHAR2(40 BYTE), 
	"GPA" VARCHAR2(40 BYTE), 
	"CLASS_NUM" VARCHAR2(40 BYTE), 
	"PASSWORD" VARCHAR2(40 BYTE), 
	"IDENTITY_NUM" VARCHAR2(40 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."TEACHER" 
   (	"TEACHER_ID" NUMBER(*,0) DEFAULT NULL, 
	"FNAME" VARCHAR2(20 BYTE), 
	"LNAME" VARCHAR2(20 BYTE), 
	"IDENTITY_NUMBER" VARCHAR2(20 BYTE), 
...
REM INSERTING into SYSTEM.A_CLASSROOM
SET DEFINE OFF;
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('1','101','201180048','1','0','1','13:30-15:20','MON');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('2','102','201180062','1','1','2','15:30-17:20','MON');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('3','101','201180062','2','0','1','13:30-15:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('4','102','201180062','2','0','2','15:30-17:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('5','102','201180048','3','0','1','09:30-12:20','MON');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('6','102','201180048','3','0','2','09:30-12:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('7','102','201180048','3','0','3','13:30-16:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('8','102','201180048','3','0','4','9:30-12:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('9','102','201180048','3','0','5','9:30-12:20','THU');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('10','102','201180048','3','0','6','13:30-16:20','THU');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('11','102','201180048','3','0','7','13:30-16:20','FRÝ');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('12','100','201180050','4','0','1','9:30-12:20','MON');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('13','100','201180050','4','0','2','13.30-17:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('14','100','201180050','4','0','3','9:30-12:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('15','100','201180050','4','0','4','13:30-17:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('16','100','201180050','4','0','5','13.30-17:20','THU');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('17','100','201180050','4','0','6','9:30-12:20','FRÝ');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('18','100','201180050','4','0','7','13:30-17:20','FRÝ');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('19','100','201180051','5','0','1','9:30-12:20','THU');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('20','100','201180051','5','0','2','13:30-17:20','THU');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('21','100','201180051','5','0','3','9:30-12:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('22','100','201180051','5','0','4','13:30-17:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('23','100','201180051','5','0','5','9:30-12:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('24','100','201180051','5','0','6','13:30-17:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('25','100','201180051','5','0','7','13:30-17:20','FRÝ');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('26','100','201180051','6','0','1','9:30-12:20','TUE');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('27','100','201180051','6','0','2','9:30-12:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('28','102','201180048','7','0','1','20.30-21:20','THU');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('29','102','201180048','7','0','2','20:30-21:20','WED');
Insert into SYSTEM.A_CLASSROOM (CLASSROOM_ID,TEACHER_ID,STUDENT_ID,COURSE_ID,ATTANDANCE,SECTION_NUM,HOUR,DAY) values ('30','102','201180048','7','0','3','20:30-21:20','FRÝ');
REM INSERTING into SYSTEM.A_CLASSROOM_STUDENT
SET DEFINE OFF;
Insert into SYSTEM.A_CLASSROOM_STUDENT (CLASSROOM_ID,STUDENT_ID,IS_APPROVED) values ('5','201180062','0');
Insert into SYSTEM.A_CLASSROOM_STUDENT (CLASSROOM_ID,STUDENT_ID,IS_APPROVED) values ('1','201180062','0');
REM INSERTING into SYSTEM.A_COURSE
SET DEFINE OFF;
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('1','BÝLGÝSAYAR PROGRAMLAMA I','BM101','Fall','1','3','5','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('2','BÝLGÝSAYAR MÜHENDÝSLÝÐÝNE GÝRÝÞ','BM103','Fall','1','2','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('3','ENGLISH I','ENG103','Fall','1','3','3','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('4','FIZIK I','FIZ103','Fall','1','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('5','MATHEMATICS I','MATH101','Fall','1','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('6','LÝNEER CEBÝR','MAT199','Fall','1','3','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('7','ATATÜRK ÝLKELERÝ ve ÝNKILAP TARÝHÝ-I','TAR-101','Fall','1','2','2','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('8','COMPUTER PROGRAMMING II','BM102 ','Spring','1','3','5','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('9','DISCRETE MATHEMATICS','BM104','Spring','1','3','3','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('10','ENGLISH II','ENG104','Spring','1','3','3','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('11','PHYSICS LABORATORY','FIZ156','Spring','1','1','2','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('12','MATHEMATICS II','MAT102','Spring','1','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('13','PHYSICS II','PHYS104','Spring','1','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('14','HISTORY OF TURKISH REPUBLIC II','TAR-102','Fall','1','2','2','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('15','PROBABILITY AND STATISTICS','BM207','Fall','2','3','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('16','ELECTRICAL AND ELECTRONIC CIRCUITS','BM211','Fall','2','3','5','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('17','DATA STRUCTURES','CENG205 ','Fall','2','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('18','OBJECT ORIENTED PROGRAMMING','CENG213','Fall','2','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('19','ACADEMIC ENGLISH I','ENG203','Fall','2','3','3','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('20','DIFFERENTIAL EQUATIONS','MATH201','Fall','2','4','5','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('21','ALGORITHMS','BM218 ','Spring','2','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('22','DIGITAL DESIGN','BM222','Spring','2','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('23','PROGRAMMING LANGUAGES','BM224','Spring','2','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('24','NUMERICAL ANALYSIS','CENG206','Spring','2','3','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('25','ACADEMIC ENGLISH II','ENG204','Spring','2','3','3','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('26','OPERATING SYSTEMS','BM309','Fall','3','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('27','COMPUTER ARCHITECTURE','BM311','Fall','3','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('28','ENGINEERING PROJECT','BM315','Fall','3','2','2','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('29','FILE ORGANIZATION','CENG307','Fall','3','3','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('30','INTRODUCTION TO DATA SCIENCE','CENG313','Fall','3','3','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('31','FORMAL LANGUAGES AND AUTOMATA','BM312','Spring','4','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('32','SOFTWARE ENGINEERING','BM314','Spring','4','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('33','DATABASE SYSTEMS','CENG316','Spring','4','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('34','MICROPROCESSORS','CENG318','Spring','4','4','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('35','DATA COMMUNICATIONS','BM403','Fall','4','3','3','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('36','COMPUTER PROJECT I','BM495','Fall','4','3','5','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('37','OCCUPATIONAL HEALTH AND SAFETY I','ISG401','Fall','4','2','2','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('38','COMPUTER NETWORKS','BM402','Spring','4','3','4','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('39','COMPUTER PROJECT II','BM496','Spring','4','3','6','1');
Insert into SYSTEM.A_COURSE (COURSE_ID,COURSE_NAME,COURSE_CODE,SEMESTER,CLASSNUM,CREDIT,AKTS,DEPARTMENT_ID) values ('40','OCCUPATIONAL HEALTH AND SAFETY II','ISG402','Spring','4','2','2','1');
REM INSERTING into SYSTEM.A_DEPARTMENT
SET DEFINE OFF;
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('1','Computer Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('2','Industrial Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('3','Chemical Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('4','Mechanical Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('5','Electrical and Electronics Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('6','Civil Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('7','Software Engineering','1','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('8','Pharmacy','2','5');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('9','Architecture','3','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('10','City and Regional Planning and Industrial Design','3','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('11','Medicine','4','6');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('12','Dentistry','5','5');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('13','Biology','6','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('14','Physics','6','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('15','Statistic','6','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('16','Chemistry','6','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('17','Mathematics','6','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('18','Computer and Instructional Technologies Education','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('19','Educational Sciences','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('20','Fine Arts Education','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('21','Mathematics and Science Education','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('22','Foreing Languages Education','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('23','Primary Education','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('24','Turkish and Social Sciences Education','7','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('25','Nursing','8','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('26','Nutrition and Dietetics','9','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('27','Physiotherapy and Rehabilitation','9','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('28','Social Work','9','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('29','Audiology and Department of Speech and Language Therapy','9','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('30','Physical Education and Sports Teaching','10','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('31','Trainer Teaching','10','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('32','Sports Management','10','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('33','Recreation','10','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('34','Civil Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('35','Industrial Design Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('36','Electrical and Electronics Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('37','Wood Products Industrial Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('38','Metallurgy and Materials Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('39','Common Courses','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('40','Computer Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('41','Manufacturing Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('42','Energy Systems Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('43','Automative Engineering','11','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('44','Photonics','12','4');
Insert into SYSTEM.A_DEPARTMENT (DEP_ID,DEP_NAME,FACULTY_ID,DEP_YEAR) values ('45','Management Information Systems','12','4');
REM INSERTING into SYSTEM.A_FACULTY
SET DEFINE OFF;
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('1','Faculty of Engineering','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('2','Faculty of Pharmacy','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('3','Faculty of Architecture','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('4','Faculty of Medicine','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('5','Faculty of Dentistry','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('6','Faculty of Science','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('7','Faculty of Education','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('8','Faculty of Nursing','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('9','Faculty of Health Sciences','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('10','Faculty of Sport Sciences','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('11','Faculty of Technology ','Ankara');
Insert into SYSTEM.A_FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS) values ('12','Faculty of Applied Sciences','Ankara');
REM INSERTING into SYSTEM.A_GRADE
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.A_STUDENT
SET DEFINE OFF;
Insert into SYSTEM.A_STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM,DEPARTMENT_ID,FACULTY_ID,TEACHER_ID) values ('201180062','Zeynep','Yigit','zyept@gmail.com','565',null,'3','5625','16265718809','1','1','101');
Insert into SYSTEM.A_STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM,DEPARTMENT_ID,FACULTY_ID,TEACHER_ID) values ('201180048','Elifnur','Mercan','cyber@yandex.com','545',null,'3','4245','19306584703','1','1','102');
Insert into SYSTEM.A_STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM,DEPARTMENT_ID,FACULTY_ID,TEACHER_ID) values ('201180049','Elif','Can','cyber1@yandex.com','056788',null,'2','4345','98746758765','1','1','101');
Insert into SYSTEM.A_STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM,DEPARTMENT_ID,FACULTY_ID,TEACHER_ID) values ('201180050','Asya','Naz

','cyber2@yandex.com','056785',null,'1','4346','12398746657','1','1','101');
Insert into SYSTEM.A_STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM,DEPARTMENT_ID,FACULTY_ID,TEACHER_ID) values ('201180065','Asya','Gül','cyber3@yandex.com','56789',null,'4','5658','19845673356','1','1','102');
Insert into SYSTEM.A_STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM,DEPARTMENT_ID,FACULTY_ID,TEACHER_ID) values ('201180051','Ali','Tosun','cyber4@yandex.com','056777',null,'2','7879','67548930043','1','1','101');
REM INSERTING into SYSTEM.A_TEACHER
SET DEFINE OFF;
Insert into SYSTEM.A_TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('100','Ela','Ata','26780945768','es@gmail.com','1','1','1','1','1');
Insert into SYSTEM.A_TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('102','Sýla','Nur','23487659784','sýlanur@gmail.com','104','45625625','565','2','8');
Insert into SYSTEM.A_TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('101','Sýlanur','Su','23476548863','sýlanur2@gmail.com','108','456256258','56588','1','1');
Insert into SYSTEM.A_TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('105','Melike','Sýla','98745634256','mels@gmail.com','106','456255','54265655','1','1');
Insert into SYSTEM.A_TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('103','Elif','Yýldýz','13489653375','elfyýld@gmail.com','107','4562555','54265526','1','1');
REM INSERTING into SYSTEM.CLASSROOM
SET DEFINE OFF;
REM INSERTING into SYSTEM.CLASSROOM_STUDENT
SET DEFINE OFF;
REM INSERTING into SYSTEM.COURSE
SET DEFINE OFF;
REM INSERTING into SYSTEM.DEPARTMENT
SET DEFINE OFF;
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('1','Computer Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('2','Industrial Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('3','Chemical Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('4','Mechanical Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('5','Electrical and Electronics Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('6','Civil Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('7','Software Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('8','Pharmacy');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('9','Architecture');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('10','City and Regional Planning and Industrial Design');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('11','Medicine');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('12','Dentistry');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('13','Biology');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('14','Physics');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('15','Statistic');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('16','Chemistry');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('17','Mathematics');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('18','Computer and Instructional Technologies Education');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('19','Educational Sciences');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('20','Fine Arts Education');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('21','Mathematics and Science Education');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('22','Foreing Languages Education');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('23','Primary Education');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('24','Turkish and Social Sciences Education');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('25','Nursing');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('26','Nutrition and Dietetics');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('27','Physiotherapy and Rehabilitation');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('28','Social Work');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('29','Audiology and Department of Speech and Language Therapy');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('30','Physical Education and Sports Teaching');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('31','Trainer Teaching');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('32','Sports Management');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('33','Recreation');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('34','Civil Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('35','Industrial Design Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('36','Electrical & Electronics Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('37','Wood Products Industrial Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('38','Metallurgy and Materials Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('39','Common Courses');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('40','Computer Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('41','Manufacturing Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('42','Energy Systems Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('43','Automative Engineering');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('44','Photonics');
Insert into SYSTEM.DEPARTMENT (DEP_ID,DEP_NAME) values ('45','Management Information Systems');
REM INSERTING into SYSTEM.DEPARTMENT_STUDENT
SET DEFINE OFF;
Insert into SYSTEM.DEPARTMENT_STUDENT (STUDENT_ID,DEPARTMENT_ID) values ('5','2');
REM INSERTING into SYSTEM.EXAM
SET DEFINE OFF;
REM INSERTING into SYSTEM.EXAM_RESULT
SET DEFINE OFF;
REM INSERTING into SYSTEM.FACULTY
SET DEFINE OFF;
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('1','Faculty of Engineering','Çankaya/Ankara','1');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('2','Faculty of Pharmacy','Ankara','8');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('3','Faculty of Architecture','Ankara','9');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('4','Faculty of Medicine','Ankara','11');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('5','Faculty of Dentistry','Ankara','12');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('6','Faculty of Science','Ankara','13');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('7','Faculty of Education','Ankara','20');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('8','Faculty of Nursing','Ankara','25');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('9','Faculty of Health Sciences','Ankara','27');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('10','Faculty of Sport Sciences','Ankara','32');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('11','Faculty of Technology ','Ankara','34');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('12','Faculty of Applied Sciences','Ankara','44');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('13','Faculty of Engineering','Ankara','2');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('14','Faculty of Engineering','Ankara','3');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('15','Faculty of Engineering','Ankara','4');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('16','Faculty of Engineering','Ankara','5');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('17','Faculty of Engineering','Ankara','6');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('18','Faculty of Engineering','Ankara','7');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('19','Faculty of Architecture','Ankara','10');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('20','Faculty of Science','Ankara','14');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('21','Faculty of Science','Ankara','15');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('22','Faculty of Science','Ankara','16');
Insert into SYSTEM.FACULTY (FACULTY_ID,FACULTY_NAME,ADDRESS,DEPARTMENT_ID) values ('23','Faculty of Science','Ankara','17');
...
SET DEFINE OFF;
Insert into SYSTEM.STAFF (USERNAME,PASSWORD,STAFF_ID) values ('z','z','1');
REM INSERTING into SYSTEM.STUDENT
SET DEFINE OFF;
Insert into SYSTEM.STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM) values ('201180065','Sýla','Nur','df@gmail.com','56255',null,null,'5656','5656');
Insert into SYSTEM.STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM) values ('2011800','d','dd','ff','252',null,null,'552','552');
Insert into SYSTEM.STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM) values ('201180062','Zeynep','Yiðit','zye@gmail.com','5652652655',null,null,'265265225','265265225');
Insert into SYSTEM.STUDENT (STUDENT_ID,FNAME,LNAME,MAIL,PHONE_NUMBER,GPA,CLASS_NUM,PASSWORD,IDENTITY_NUM) values ('5','5','5','5','5',null,null,'5','5');
REM INSERTING into SYSTEM.TEACHER
SET DEFINE OFF;
Insert into SYSTEM.TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,USERNAME,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('5','Melike','Þahin','5226622355','melþ@gmail.com','300','5226622355','5','5656665956','1','4');
Insert into SYSTEM.TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,USERNAME,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('3','Zeynep','Su','45625565556','zsu@gmail.com','102','45625565556','3','2652665655','1','1');
Insert into SYSTEM.TEACHER (TEACHER_ID,FNAME,LNAME,IDENTITY_NUMBER,MAIL,ROOM_NUMBER,PASSWORD,USERNAME,PHONE_NUMBER,FACULTY,DEPARTMENT) values ('4','z','z','z','z','102','z','4','z','1','1');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."EXAM_PK" ON "SYSTEM"."EXAM" ("EXAM_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index UNIQUE_IDENTITY_CONSTRAINT
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UNIQUE_IDENTITY_CONSTRAINT" ON "SYSTEM"."A_TEACHER" ("IDENTITY_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."STAFF_PK" ON "SYSTEM"."STAFF" ("STAFF_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index A_TEACHER_UK3
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UK3" ON "SYSTEM"."A_TEACHER" ("PHONE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index A_TEACHER_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UK1" ON "SYSTEM"."A_TEACHER" ("ROOM_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."COURSE_PK" ON "SYSTEM"."COURSE" ("COURSE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."DEPARTMENT_PK" ON "SYSTEM"."DEPARTMENT" ("DEP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index A_TEACHER_UK2
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UK2" ON "SYSTEM"."A_TEACHER" ("PASSWORD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index A_STUDENT_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."A_STUDENT_UK1" ON "SYSTEM"."A_STUDENT" ("PHONE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index UNIQUE_EMAIL_CONSTRAINT
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UNIQUE_EMAIL_CONSTRAINT" ON "SYSTEM"."A_STUDENT" ("MAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."TEACHER_PK" ON "SYSTEM"."TEACHER" ("TEACHER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."FACULTY_PK" ON "SYSTEM"."FACULTY" ("FACULTY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index UNIQUE_PASS_CONS
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UNIQUE_PASS_CONS" ON "SYSTEM"."A_STUDENT" ("PASSWORD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index UNIQUE_IDENTITY_NUM_CONSTRAINT
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UNIQUE_IDENTITY_NUM_CONSTRAINT" ON "SYSTEM"."A_STUDENT" ("IDENTITY_NUM") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."GRADE_PK" ON "SYSTEM"."GRADE" ("GRADE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index A_TEACHER_UNÝQUE_MAÝL
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UNÝQUE_MAÝL" ON "SYSTEM"."A_TEACHER" ("MAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CLASSROOM_PK" ON "SYSTEM"."CLASSROOM" ("CLASSROOM_ID", "TEACHER_ID", "COURSE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."STUDENT_PK" ON "SYSTEM"."STUDENT" ("STUDENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EXAM_RESULT" MODIFY ("EXAM_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXAM_RESULT" MODIFY ("STUDENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXAM_RESULT" MODIFY ("COURSE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXAM_RESULT" MODIFY ("MARKS" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table FACULTY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FACULTY" MODIFY ("FACULTY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACULTY" MODIFY ("FACULTY_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACULTY" MODIFY ("ADDRESS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACULTY" ADD CONSTRAINT "FACULTY_PK" PRIMARY KEY ("FACULTY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."COURSE" MODIFY ("COURSE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COURSE" ADD CONSTRAINT "COURSE_PK" PRIMARY KEY ("COURSE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."COURSE" MODIFY ("FACULTY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COURSE" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COURSE" MODIFY ("DEPARTMENT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COURSE" MODIFY ("COURSE_DATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COURSE" MODIFY ("COURSE_TIME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STAFF" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STAFF" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STAFF" MODIFY ("STAFF_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STAFF" ADD CONSTRAINT "STAFF_PK" PRIMARY KEY ("STAFF_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DEPARTMENT" ADD CONSTRAINT "DEPARTMENT_PK" PRIMARY KEY ("DEP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DEPARTMENT" MODIFY ("DEP_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DEPARTMENT" MODIFY ("DEP_NAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table A_GRADE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_GRADE" ADD PRIMARY KEY ("GRADE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table A_TEACHER
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("FNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("LNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("IDENTITY_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("MAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("ROOM_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" MODIFY ("PHONE_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD PRIMARY KEY ("TEACHER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD CONSTRAINT "EMAIL_CONSTRAINT" CHECK (REGEXP_LIKE(MAIL,'.*@.*')) ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD CONSTRAINT "UNIQUE_IDENTITY_CONSTRAINT" UNIQUE ("IDENTITY_NUMBER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD CONSTRAINT "A_TEACHER_UNIQUE_MAÝL" UNIQUE ("MAIL")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UNÝQUE_MAÝL" ON "SYSTEM"."A_TEACHER" ("MAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" )  ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD CONSTRAINT "UNIQUE_ROOM_NUM_CONSTRAINT" UNIQUE ("ROOM_NUMBER")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UK1" ON "SYSTEM"."A_TEACHER" ("ROOM_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" )  ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD CONSTRAINT "UNIQUE_PASSWORD_CONSTRAINT" UNIQUE ("PASSWORD")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UK2" ON "SYSTEM"."A_TEACHER" ("PASSWORD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" )  ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD CONSTRAINT "UNIQUE_PHONE_NUM_CONSTRAINT" UNIQUE ("PHONE_NUMBER")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."A_TEACHER_UK3" ON "SYSTEM"."A_TEACHER" ("PHONE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("STUDENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("FNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("LNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("MAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("PHONE_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" MODIFY ("IDENTITY_NUM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."STUDENT" ADD CONSTRAINT "STUDENT_PK" PRIMARY KEY ("STUDENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."GRADE" MODIFY ("GRADE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GRADE" MODIFY ("GRADE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GRADE" ADD CONSTRAINT "GRADE_PK" PRIMARY KEY ("GRADE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table A_FACULTY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_FACULTY" MODIFY ("FACULTY_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_FACULTY" MODIFY ("ADDRESS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_FACULTY" ADD PRIMARY KEY ("FACULTY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLASSROOM" MODIFY ("TEACHER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASSROOM" MODIFY ("COURSE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASSROOM" MODIFY ("CLASSROOM_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLASSROOM" ADD CONSTRAINT "CLASSROOM_PK" PRIMARY KEY ("CLASSROOM_ID", "TEACHER_ID", "COURSE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EXAM" MODIFY ("EXAM_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXAM" MODIFY ("EXAM_TYPE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EXAM" ADD CONSTRAINT "EXAM_PK" PRIMARY KEY ("EXAM_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table A_COURSE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_COURSE" ADD CHECK (semester IN ('Fall', 'Spring')) ENABLE;
  ALTER TABLE "SYSTEM"."A_COURSE" ADD PRIMARY KEY ("COURSE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_COURSE" ADD UNIQUE ("COURSE_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table A_DEPARTMENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_DEPARTMENT" MODIFY ("DEP_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_DEPARTMENT" ADD PRIMARY KEY ("DEP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table A_CLASSROOM
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_CLASSROOM" ADD PRIMARY KEY ("CLASSROOM_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."A_STUDENT" MODIFY ("FNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_STUDENT" MODIFY ("LNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_STUDENT" MODIFY ("MAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_STUDENT" MODIFY ("PHONE_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_STUDENT" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_STUDENT" MODIFY ("IDENTITY_NUM" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD PRIMARY KEY ("STUDENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD CONSTRAINT "A_STUDENT_MAIL" CHECK (REGEXP_LIKE(MAIL, '.*@.*')) ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD CONSTRAINT "UNIQUE_EMAIL_CONSTRAINT" UNIQUE ("MAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD CONSTRAINT "UNIQUE_IDENTITY_NUM_CONSTRAINT" UNIQUE ("IDENTITY_NUM")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD CONSTRAINT "UNIQUE_PASS_CONS" UNIQUE ("PASSWORD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD CONSTRAINT "UNIQUE_PHONE_NUML_CONSTRAINT" UNIQUE ("PHONE_NUMBER")
  USING INDEX (CREATE UNIQUE INDEX "SYSTEM"."A_STUDENT_UK1" ON "SYSTEM"."A_STUDENT" ("PHONE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" )  ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD CONSTRAINT "CHK_TC_IDENTITY_NO_LENGTH" CHECK (LENGTHB(IDENTITY_NUM) = 11) ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("FACULTY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("TEACHER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" ADD CONSTRAINT "TEACHER_PK" PRIMARY KEY ("TEACHER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("FNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("LNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("IDENTITY_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("MAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("ROOM_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("PHONE_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEACHER" MODIFY ("DEPARTMENT" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_CLASSROOM
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_CLASSROOM" ADD FOREIGN KEY ("TEACHER_ID")
	  REFERENCES "SYSTEM"."A_TEACHER" ("TEACHER_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_CLASSROOM" ADD FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "SYSTEM"."A_STUDENT" ("STUDENT_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_CLASSROOM" ADD CONSTRAINT "FK_HEDEFTABLO_COURSE" FOREIGN KEY ("COURSE_ID")
	  REFERENCES "SYSTEM"."A_COURSE" ("COURSE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_CLASSROOM_STUDENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_CLASSROOM_STUDENT" ADD CONSTRAINT "FK_STU" FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "SYSTEM"."A_STUDENT" ("STUDENT_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_CLASSROOM_STUDENT" ADD CONSTRAINT "FK_CLAS" FOREIGN KEY ("CLASSROOM_ID")
	  REFERENCES "SYSTEM"."A_CLASSROOM" ("CLASSROOM_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_COURSE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_COURSE" ADD FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."DEPARTMENT" ("DEP_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_DEPARTMENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_DEPARTMENT" ADD FOREIGN KEY ("FACULTY_ID")
	  REFERENCES "SYSTEM"."FACULTY" ("FACULTY_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_GRADE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_GRADE" ADD FOREIGN KEY ("CLASSROOM_ID")
	  REFERENCES "SYSTEM"."A_CLASSROOM" ("CLASSROOM_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_GRADE" ADD FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "SYSTEM"."A_STUDENT" ("STUDENT_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_STUDENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_STUDENT" ADD FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."A_DEPARTMENT" ("DEP_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD FOREIGN KEY ("FACULTY_ID")
	  REFERENCES "SYSTEM"."A_FACULTY" ("FACULTY_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_STUDENT" ADD FOREIGN KEY ("TEACHER_ID")
	  REFERENCES "SYSTEM"."A_TEACHER" ("TEACHER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table A_TEACHER
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."A_TEACHER" ADD FOREIGN KEY ("FACULTY")
	  REFERENCES "SYSTEM"."A_FACULTY" ("FACULTY_ID") ENABLE;
  ALTER TABLE "SYSTEM"."A_TEACHER" ADD FOREIGN KEY ("DEPARTMENT")
	  REFERENCES "SYSTEM"."A_DEPARTMENT" ("DEP_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CLASSROOM
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CLASSROOM" ADD CONSTRAINT "CLASSROOM_FK1" FOREIGN KEY ("TEACHER_ID")
	  REFERENCES "SYSTEM"."TEACHER" ("TEACHER_ID") ENABLE;
  ALTER TABLE "SYSTEM"."CLASSROOM" ADD CONSTRAINT "CLASSROOM_FK2" FOREIGN KEY ("COURSE_ID")
	  REFERENCES "SYSTEM"."COURSE" ("COURSE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DEPARTMENT_STUDENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DEPARTMENT_STUDENT" ADD CONSTRAINT "DEPARTMENT_STUDENT_FK2" FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."DEPARTMENT" ("DEP_ID") ENABLE;
  ALTER TABLE "SYSTEM"."DEPARTMENT_STUDENT" ADD CONSTRAINT "DEPARTMENT_STUDENT_FK1" FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "SYSTEM"."STUDENT" ("STUDENT_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EXAM_RESULT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EXAM_RESULT" ADD CONSTRAINT "EXAM_RESULT_FK2" FOREIGN KEY ("EXAM_ID")
	  REFERENCES "SYSTEM"."EXAM" ("EXAM_ID") ENABLE;
  ALTER TABLE "SYSTEM"."EXAM_RESULT" ADD CONSTRAINT "EXAM_RESULT_FK1" FOREIGN KEY ("COURSE_ID")
	  REFERENCES "SYSTEM"."COURSE" ("COURSE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FACULTY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FACULTY" ADD CONSTRAINT "FACULTY_FK1" FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."DEPARTMENT" ("DEP_ID") ENABLE;
--------------------------------------------------------
